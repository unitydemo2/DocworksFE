...
**NOTE**: This tool is extra functionality to Unity's standard functionality. To access it, you have to download it from [GitHub](https://github.com/Unity-Technologies/AssetBundles-Browser) and install it separately from the standard Unity Editor's download and install. 
...
The window is broken into four sections: Bundle List, Bundle Details, Asset List, and Asset Details. ![](../uploads/Main/AssetBundles-Browser-1.png)
...
![Icon for standard bundle](../uploads/Main/AssetBundles-Browser-2.png)

![Icon for scene bundle](../uploads/Main/AssetBundles-Browser-3.png)
